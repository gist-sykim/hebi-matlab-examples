...
trajGen.setMinDuration(0.2); % Min move time for 'small' movements
                             % (default is 1.0)
trajGen.setSpeedFactor(1); % Slow down movements to a safer speed.
                             % (default is 1.0)
% Keyboard input
kb = HebiKeyboard();
...
group.send('gains', HebiUtils.loadGains('6dof_gains_teach'));
...
group.send('gains', HebiUtils.loadGains('6dof_gains_repeat'));
